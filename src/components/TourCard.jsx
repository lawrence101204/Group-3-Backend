  ...
  return (
    <div
      className="
        ...
        /* Hover Effects */
        hover:shadow-xl hover:-translate-y-1 hover:bg-green-50 hover:border-green-400
    ...
    >
      ...
      <div className="flex gap-2 mt-4">
        <button
          className="
            flex-1 border border-gray-400 rounded-full text-sm py-[6px] 
        ...
        <button
          className="
            flex-1 bg-[#d3ebd7] text-gray-800 rounded-full text-sm py-[6px] 
            hover:bg-[#bcdcc8] 
            transition-all duration-200 active:scale-95
          "
